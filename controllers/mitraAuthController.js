...
exports.mitraLogin = async (req, res) => {
  try {
    ...
    const validProjects = ['jne', 'mup', 'indomaret', 'unilever', 'wings', 'primaku'];
    ...
    const driverRole = driver.role || null;
...
exports.verifyMitraToken = async (req, res) => {
  try {
    const { driver_id, project, user_id, blitz_username, blitz_password, role } = req.mitra;
